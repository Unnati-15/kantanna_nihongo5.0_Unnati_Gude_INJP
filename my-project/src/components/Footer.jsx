...
const Footer = () => {
  return (
    <footer className="footer footer-center p-6 bg-gradient-to-r from-yellow-300 to-yellow-500 text-sky-500 text-xl fixed bottom-0 left-0 w-full rounded-t-lg shadow-lg">
